                     ...
                     const uint32_t Lf)
{
    ...
    if (compareMetric == diskann::Metric::INNER_PRODUCT)
    {
        ...
        {
            std::cout << "Preprocessed base file already exists: " << prepped_base << ". Skipping preprocessing."
                    << std::endl;
        }
        else
        {
    ...
    else if (compareMetric == diskann::Metric::COSINE)
    {
        ...
        if (file_exists(prepped_base))
        {
            std::cout << "Normalized base file already exists: " << prepped_base << ". Skipping normalization."
                    << std::endl;
        }
        else
        {
