...
{
#endif
    diskann::cout << "Debug: pivots_filepath = " << pivots_filepath << std::endl;
...
#endif
    diskann::cout << "Debug: pq_file_num_centroids = " << pq_file_num_centroids << std::endl;
...
// read index metadata
...
#else
    diskann::cout << "Debug: _disk_index_file = " << _disk_index_file << std::endl;
    ...
    diskann::cout << "Debug: nr = " << nr << ", nc = " << nc << std::endl;
    uint64_t disk_nnodes;
    uint64_t disk_ndims; // can be disk PQ dim if disk_PQ is set to true
    READ_U64(index_metadata, disk_nnodes);
    READ_U64(index_metadata, disk_ndims);
    diskann::cout << "Debug: disk_nnodes = " << disk_nnodes << ", disk_ndims = " << disk_ndims << std::endl;
